...
layer_background_sprite(layer_background_get_id("Background"),sClassroom);
...
Say(4, "Nar","At least that is the plan if you knew what they said. BTW why are all the other students looking strange at you, you just picked books from the New Super Fire Wall category.");
