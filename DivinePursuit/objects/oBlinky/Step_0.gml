...
if(!isMoving){
	...
	var distArr = [point_distance(x,y-32,playerInst.x,playerInst.y),
				point_distance(x+32,y,playerInst.x,playerInst.y),
				point_distance(x,y+32,playerInst.x,playerInst.y),
				point_distance(x-32,y,playerInst.x,playerInst.y)];
	moveDirection = 0;				
	var lowVar = 9999;
	for(i = 0; i < 4; i++)
